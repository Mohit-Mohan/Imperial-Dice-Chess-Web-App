...
// This file holds all information regarding the game of chess,
// and its prevalent rules, the functions do include all piece patterns, check,
// checkmate, fastpawn, and castling, however niche rules like en passant,
// stalemate scenarios and promotion were not programmed due to pausity of time
// and also as they were deemed unecessary to coincide with a more fun version
// of chess, hence the dice were added for an added twist. These are however, 
// easy to integrate with the current code if need be.
// The file consists of classes to arrange information in constructors and 
// pass them to required functions when necessary, 
// this allows easy flow of code with a mixture of oop and functional
// programming, with major use of arrow functions, mapping, filters,
// foreach, for of and while loops to create the boards and all functions, 
// described line by line through adequate commentary.
...
class Square {
	...
	create() {
		...
		squareElement.setAttribute("data-position", this.info.position); // position
